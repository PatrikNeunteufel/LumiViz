...
| [old_docs/](old_docs/README.md) | Alte LumiViz-App-Doku (Stand vor Neuordnung Session 29) — Quelle für die neue Domänen-Doku | LumiViz `projects/apps/LumiViz/docs/` | **Phase 4** — Doku-Neuaufbau; nach Übernahme löschen |
