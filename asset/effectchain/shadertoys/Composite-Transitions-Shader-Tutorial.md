...
- *Crystal-Lights-Shader-Tutorial.md* – **Welt A**: das halbliquide Kristall-Terrain über blinkenden `1/d²`-Leuchtkörpern. Wir übernehmen sein Höhenfeld, sein Lampenraster, seine Brechung – als kompaktes Skelett.
- *Juggernaut-Shader-Tutorial.md* – **Welt B**: der kolossale Moloch im Dunst, dark-Stimmung, God-Ray-Glow, Positionslichter. Ebenfalls als Skelett. Die beiden Welten sind mit Absicht **maximal verschieden**: Terrain vs. Objekt, bunt vs. monochrom-dunkel, Blick von oben vs. Low-Angle-Orbit – wenn der Übergang *dieses* Paar schafft, schafft er jedes.
...
- **Dieses Tutorial ist am Schreibtisch konstruiert, nicht gerendert und nicht getestet.** Die Schritte sind so gebaut, dass jeder für sich kompilieren sollte, die kritischen Formeln (Plateau-Amplitude, Masken-Vertrag, Zustandsübergänge) sind nachgerechnet – aber Tippfehler, GLSL-Pedanterien und vor allem *ästhetische* Fehleinschätzungen (eine Glut zu fett, ein Morph zu früh, ein Kick zu laut) zeigen sich erst am lebenden Bild. Wer beim Nachbauen stolpert: Die „Was passiert hier"-Abschnitte tragen jeweils die Absicht – sie ist im Zweifel verlässlicher als die Konstante daneben.
