...
SSOT ist das Tutorial-Markdown (../Pyramid-Spiral-Shader-Tutorial.md):
...
TUTORIAL = HIER.parent / "Pyramid-Spiral-Shader-Tutorial.md"
                ...
                "children": [
                    {
                        ...
                        + " (generiert aus Pyramid-Spiral-Shader-Tutorial.md, SSOT dort)",
