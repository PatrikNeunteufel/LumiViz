...
- **Dieses Tutorial ist am Schreibtisch konstruiert, nicht gerendert und nicht getestet.** Die Schritte sind so gebaut, dass jeder für sich kompilieren sollte, und die kritischen Konstanten sind nachgerechnet – aber Tippfehler, GLSL-Pedanterien und vor allem *ästhetische* Fehleinschätzungen (eine Fuge zu breit, ein Glow zu fett) sind erst am lebenden Bild zu finden. Wer beim Nachbauen stolpert: Die „Was passiert hier"-Abschnitte enthalten jeweils die Absicht – sie ist im Zweifel verlässlicher als die Konstante daneben.
