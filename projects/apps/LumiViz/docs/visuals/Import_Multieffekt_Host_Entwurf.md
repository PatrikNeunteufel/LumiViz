# LumiViz — Multieffekt-Host (Entwurf, Import-Phase Roadmap 5)
...
| E7 | Übersetzer-Ort | **(a)** im App-Modul (`LumiViz`) — erzeugt GL-nahe Laufzeitobjekte, gehört nicht in eine Qt-freie Lib |
