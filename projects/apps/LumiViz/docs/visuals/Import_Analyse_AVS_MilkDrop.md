...
| Host-Funktionen | `getosc/getspec/gettime` als C-Callbacks aus LumiViz; `getkbmouse/setmousepos` als No-op-Stubs |
...
Render-Thread; `gmegabuf`/`regs` als von LumiViz verwaltete Strukturen.
