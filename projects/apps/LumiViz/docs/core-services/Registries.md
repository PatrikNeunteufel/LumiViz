...
Self-Registration in Übersetzungseinheiten; der produktive Weg in LumiViz ist aber
...
|----|-------|-------|-------|-----------|----------|
| `about` | About LumiViz | 900 | ja | Help | F1 |
...
Help (900)
└── About LumiViz... (F1)              → OpenDialogEvent{"about"}
```
