...
zeilenweise geflusht nach `LumiViz.log`, jede Stufe oben hinterlässt eine Marke.
...
Für Teardown-Fragen ist das der vorgesehene Weg; `LumiViz.log` ist zeilenweise
