...
Dieses Tutorial ist der direkte Nachfolger von **CrystalLights-tutorial.md** (gleicher Ordner) und übernimmt dessen Schule: Stilmittel eines Milkdrop-Presets studieren, die Technik aber eigenständig und von Grund auf entwickeln.
...
![Schritt 1: Polar-Skizze des Tunnelblicks](stratospheric_tunnel_bilder/schritt_01.png)
...
![Schritt 2: der geraymarchte Zylinder mit z-Streifen](stratospheric_tunnel_bilder/schritt_02.png)
...
![Schritt 3: Schachbrett-Wand mit Kamera-Scheinwerfer](stratospheric_tunnel_bilder/schritt_03.png)
...
![Schritt 4: Röhrenbündel mit Spanten-Ringen](stratospheric_tunnel_bilder/schritt_04.png)
...
![Schritt 5: Rausch-Relief auf der Röhrenwand](stratospheric_tunnel_bilder/schritt_05.png)
...
![Schritt 6: Fensteröffnungen in der Wand, dahinter noch stumpfes Nachtblau](stratospheric_tunnel_bilder/schritt_06.png)
...
![Schritt 7: Blick durch die Fenster auf Sterne und Horizontglühen](stratospheric_tunnel_bilder/schritt_07.png)
...
![Schritt 8: Neon-Streifen in den Röhrenfugen](stratospheric_tunnel_bilder/schritt_08.png)
...
![Schritt 9: Ring-Licht in der Tiefe und Fensterlicht-Flecken auf der Wand](stratospheric_tunnel_bilder/schritt_09.png)
...
![Schritt 10: der Tunnel folgt dem gekrümmten Pfad](stratospheric_tunnel_bilder/schritt_10.png)
...
![Schritt 11: Kurvenfahrt mit Banking](stratospheric_tunnel_bilder/schritt_11.png)
...
![Schritt 12: die Vergabelung – zwei Tunnelmündungen voraus](stratospheric_tunnel_bilder/schritt_12.png)
...
![Schritt 13: der fertige Shader – Nebel, Farbdrift, Tonemapping](stratospheric_tunnel_bilder/schritt_13.png)
...
![Anhang A1: Bass-Pegel, Beat-Gate und Puls-Ring (synthetisches Testsignal des Standalone – die Pegel sättigen nahe 1)](stratospheric_tunnel_bilder/anhang_a1.png)
...
![Anhang A3: der Tunnel hört zu (synthetisches Testsignal des Standalone – das Beat-Gate steht dauerhaft offen, alle Fugen leuchten)](stratospheric_tunnel_bilder/anhang_a3.png)
...
**Ein ehrliches Wort zum Schluss:** Alle Schritte dieses Tutorials sind sorgfältig konstruiert und gegengerechnet (Steigungen, Naht-Bedingungen, Helligkeits-Größenordnungen) und inzwischen **in LumiViz gegengerendert** (alle Schritte kompilieren warnungsfrei; die Screenshots im Text stammen aus diesen Läufen) – auf shadertoy.com ist der Sichttest weiterhin offen. Der Render-Lauf bestätigt einen der erwarteten Nachstimm-Kandidaten: Die Schritte 3–7 fallen vor dem Neon/Tonemapping deutlich dunkler aus, als die Ergebnis-Texte suggerieren. Erste Verdächtige fürs Feintuning bleiben die Helligkeiten (`NEON_STAERKE`, `RING_STAERKE`, Tonemapping-Belichtung `1.6`), die Nebel-Konstanten und die Marsch-Drossel `0.7` bei aggressiven `KURVE`-/`RELIEF`-Werten – die Struktur trägt.
