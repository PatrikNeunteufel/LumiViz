...
// Schritt 8 + K_TIEFE/K_DICHTE/K_ZELLE, kristallLampen, shadeKristall;
// der Dispatch ersetzt die Debug-Farbe.
// ============================================================================
...
// GEAENDERT: mainImage - der Dispatch bekommt sein zweites Material
