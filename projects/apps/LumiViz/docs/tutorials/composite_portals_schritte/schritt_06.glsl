// ============================================================================
// Schritt 6 - Portal-Politur: atmende Oeffnung und Neon-Rahmen.
// Materialisierte Rekonstruktion (SSOT: CompositePortals-tutorial.md):
// Schritt 5 + P_ATMEN/P_RAHMEN; fensterDist ersetzt tunnelFenster;
// portalRahmen; Portal-Block arbeitet auf der signierten Distanz.
// ============================================================================
