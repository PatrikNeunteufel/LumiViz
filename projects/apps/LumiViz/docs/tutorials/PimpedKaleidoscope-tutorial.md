...
- LumiViz/LumiViz mit Shadertoy-Node in der Effect-Chain, inklusive Multipass-Unterstützung Buffer A–D (Stand Session 65/67); für den URL-Import zusätzlich ein kostenloser Shadertoy-App-Key.
