// ============================================================================
// "Juggernaut" - Anhang A3: Der Moloch hoert zu.
// Gesamtlisting aus Schritt 14 + Audio-Mappings 1-5 aus Anhang A2/A3.
// iChannel0 = Music (auf shadertoy.com; in LumiViz die Audio-Textur des Nodes).
// ============================================================================
...
float gStimmung = STIMMUNG;            // Laufzeit-Kopie: das Audio laesst sie driften
...
float fenster(vec3 q)    // q in Objekt-Koordinaten (dreht mit dem Moloch mit)
{
    ...
    blink = max(blink, gGate * (0.5 + 0.5 * hash31(z + 41.0)));          // [2]
...
vec3 shade(vec3 p, vec3 rd, float t)
{
    ...
    // Positionslichter: Emission waechst mit den Mitten                  [4]
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    if (t > 0.0) {
        ...
        // Dunst - im dark-Setup deutlich dichter
