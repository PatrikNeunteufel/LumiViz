...
AboutDialog::AboutDialog(ServiceContainer& services, QWidget* parent)
    : DialogBase(services, tr("About MyViz"), parent)
{
    setupUI();
    setupConnections();
...
void AboutDialog::setupUI()
{
    ...
    // Title
    m_pTitleLabel = new QLabel(QStringLiteral("MyViz"), this);
    ...
    // Version
    m_pVersionLabel = new QLabel(QStringLiteral("Version 0.1.0"), this);
...
REGISTER_DIALOG_SHORTCUT("about", "About MyViz", "Help", 900, "F1", AboutDialog)
