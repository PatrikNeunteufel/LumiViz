 ...
 * @brief  Application-specific widget registrations for MyViz
 *
 ...
 *
 * @details
 * Diese Datei definiert die **MyViz-spezifischen Widgets**.
 ...
 * - **WidgetAutoReg.cpp** = MyViz-spezifische Widgets (diese Datei)
 *
 * ## Linker-Garantie
 *
...
/**
 * @brief Register all default widgets for MyViz
 * 
