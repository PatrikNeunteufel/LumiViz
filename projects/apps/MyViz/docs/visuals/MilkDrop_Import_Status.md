...
| 2 | **N3.2 numerische Editoren:** Preset-Basisparameter (decay/zoom/rot/warp/wave_\*/mv_\*/blur\*/Borders/Composite) + Wave-/Shape-Init-Params. **Entscheid 2026-07-23: klassische Editoren jetzt** — nicht aufs „dynamische Modulparameter"-Modell warten (PresetState bleibt SSOT; spätere Dynamisierung ersetzt nur die Editor-Schicht) | N3.2 | eigene Session (Fläche) |
| 3 | **HG1 Host-Gruppen-Fundament:** Node-Typ `HostGroupParams`, Runtime-Trennung je Gruppe, Tiefenregel, `.lvfx2`, .lvfx-Import in Gruppe — bewusst ohne Crossfade | E5 / HG1 | Entwurf [HostGruppen_Crossfade_Entwurf.md](HostGruppen_Crossfade_Entwurf.md) v1.2.0 — **freigegeben (2026-07-23)**; Anzahl Gruppen unbegrenzt, mehrere gleichzeitig aktiv erlaubt (§2.6) |
| 4 | **HG2 Crossfade-Mix:** Zustandsmodell, Bild-Mix mit **individuellen Ein-/Ausgangskurven je Gruppe** (out-Kurve(A) × in-Kurve(B); Wechsel-Settings synchron mit UI-Hinweis) | E5 / HG2 | echtes Doppel-Rendering (E5), beide audio-live |
