// ============================================================================
// Schritt 3 - Namespacing: zwei Welten in einer Datei (Split-Screen).
// Materialisierte Rekonstruktion aus CompositePortals-tutorial.md (SSOT):
// T-Block (S1) + D-Block (S2) + gemeinsame Helfer + Debris- und
// Tunnel-Funktionen (je ohne eigene Helfer) + Split-Screen-mainImage.
// ============================================================================
