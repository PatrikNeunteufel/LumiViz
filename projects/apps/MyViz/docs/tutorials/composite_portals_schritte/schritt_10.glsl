// ============================================================================
// Schritt 10 - Anti-Aliasing: Kanten in Pixelbreite (fwidth) und
// 2x2-Supersampling (Stellschraube AA, Default 1 = aus).
// Materialisierte Rekonstruktion (SSOT: CompositePortals-tutorial.md):
// Schritt 9, Bildaufbau nach render(uv), Belichtung nach der AA-Schleife.
// ============================================================================
