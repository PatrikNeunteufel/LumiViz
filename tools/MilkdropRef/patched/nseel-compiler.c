...
/* MilkdropRef-Patch (Vorbild AvsRef): __floor ist in modernem MSVC ein
   reservierter Intrinsic-Name (C2169/C7552) — Wrapper umbenannt,
   Semantik unveraendert */
static double eel_floorwrap(double a) { return floor(a); }
#endif

/* MilkdropRef-Patch (Vorbild AvsRef): Adressen von dllimport-CRT-Funktionen
   sind in statischen Initialisierern keine Konstanten mehr (C2099) —
   Wrapper statt Zeiger-Alias, Semantik unveraendert */
static double eel_asinwrap(double a) { return asin(a); }
static double eel_acoswrap(double a) { return acos(a); }
static double eel_atanwrap(double a) { return atan(a); }
static double eel_atan2wrap(double a, double b) { return atan2(a, b); }
static double eel_powwrap(double a, double b) { return pow(a, b); }
static double eel_expwrap(double a) { return exp(a); }
static double eel_ceilwrap(double a) { return ceil(a); }
...
#endif
   { "asin",   nseel_asm_1pdd,nseel_asm_1pdd_end,  1, {&eel_asinwrap}, },
   { "acos",   nseel_asm_1pdd,nseel_asm_1pdd_end,  1, {&eel_acoswrap}, },
   { "atan",   nseel_asm_1pdd,nseel_asm_1pdd_end,  1, {&eel_atanwrap}, },
   { "atan2",  nseel_asm_2pdd,nseel_asm_2pdd_end, 2, {&eel_atan2wrap}, },
...
#endif
   { "pow",    nseel_asm_2pdd,nseel_asm_2pdd_end,   2, {&eel_powwrap}, },
   { "_powop",    nseel_asm_2pdds,nseel_asm_2pdds_end,   2, {&eel_powwrap}, },
   { "exp",    nseel_asm_1pdd,nseel_asm_1pdd_end,   1, {&eel_expwrap}, },
#ifdef __ppc__
...
#if defined(_MSC_VER) && _MSC_VER >= 1400
   { "floor",  nseel_asm_1pdd,nseel_asm_1pdd_end, 1, {&eel_floorwrap} }, /* MilkdropRef-Patch */
#else
   { "floor",  nseel_asm_1pdd,nseel_asm_1pdd_end, 1, {&floor} },
#endif
   { "ceil",   nseel_asm_1pdd,nseel_asm_1pdd_end,  1, {&eel_ceilwrap} },
#ifdef __ppc__
