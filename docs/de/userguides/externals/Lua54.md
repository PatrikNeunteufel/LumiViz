...
> **Sprache:** Deutsch  
> **English:** [lua54.md](../../../en/userguides/externals/Lua54.md)
...
| 📝 **Flexibel** | Konfiguration, Modding, Scripting |

### Anwendungsfälle

| Anwendung | Beschreibung |
|-----------|--------------|
| **Konfiguration** | Lua-Dateien statt JSON/XML |
...
- [Local_Externals_Scripting.md](../../references/externals/Local_Externals_Scripting.md) — Referenz
