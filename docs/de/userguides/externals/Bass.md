...
> **Sprache:** Deutsch  
> **English:** [bass.md](../../../en/userguides/externals/Bass.md)
...
BASS_FXSetParameters(eq, &params);
```
...
- [Local_Externals_Media.md](../../references/externals/Local_Externals_Media.md) — Referenz
