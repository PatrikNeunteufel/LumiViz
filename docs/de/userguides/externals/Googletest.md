...
> **Sprache:** Deutsch  
> **English:** [googletest.md](../../../en/userguides/externals/Googletest.md)
...
EXPECT_CALL(mock, method(_))           // Beliebiger Parameter
    .With(Eq(5))                       // Gleich 5
    .With(HasSubstr("test"))           // Enthält "test"
    .With(StartsWith("hello"));        // Beginnt mit "hello"
```

### 5.5 Vollständiges Beispiel
...
- [Git_Externals_Testing.md](../../references/externals/Git_Externals_Testing.md) — Referenz
