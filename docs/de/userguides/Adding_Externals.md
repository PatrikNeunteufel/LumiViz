...
> **Sprache:** Deutsch  
> **English:** [Adding_Externals_UserGuide.md](../../en/userguides/Adding_Externals.md)
...
- **Primär:** Build-System-Entwickler, die das External-System erweitern
- **Sekundär:** C++ Entwickler, die neue Bibliotheken integrieren möchten
...
| Solution.json Schema | Korrekte Konfiguration |
...
**Problem:** Fehler in der CMakeLists.txt des Externals.
...
2. Pfad: `cmake/externals/Hooks/PreFetch/` oder `PostFetch/`
...
- [Git_Externals_Reference.md](../references/externals/Git_Externals.md) – Externe Bibliotheken Übersicht
...
|---------|-------|------------|
| **0.5.0** | **2025-12-14** | **Blueprint v0.5.0 Konformität: Nummerierte TOC, Voraussetzungen, Stolpersteine/Troubleshooting getrennt, Siehe auch** |
