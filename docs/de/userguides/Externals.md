...
> **Sprache:** Deutsch  
> **English:** [Externals.md](../../en/userguides/Externals.md)
...
4. [Reihenfolge und Abhängigkeiten](#4-reihenfolge-und-abhängigkeiten)
...
Einige Externals haben **Abhängigkeiten**, die eine bestimmte Reihenfolge erfordern:
...
- [Externals.md](../references/Externals.md) — Referenz aller Externals
- [Local_Externals.md](../references/externals/Local_Externals.md) — Local Externals Referenz
- [Git_Externals.md](../references/externals/Git_Externals.md) — Git Externals Referenz
