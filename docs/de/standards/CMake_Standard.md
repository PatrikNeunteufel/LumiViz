...
> **Sprache:** Deutsch  
> **English:** [CMake_Standard.md](../../en/standards/CMake_Standard.md)
...
5. [Externe Abhängigkeiten](#5-externe-abhängigkeiten)
6. [Fehler- und Logging-Verhalten](#6-fehler--und-logging-verhalten)
7. [Presets](#7-presets)
...
Alle Entwickler, die CMake für Build-Konfiguration verwenden. Dieser Standard ist verbindlich für neue Projekte und empfohlen bei Modernisierung bestehender Projekte.
...
**Keine** Detail-Konfiguration in Root.
...
| Target-Typ | Konvention | Beispiel |
|------------|------------|----------|
...
## 6. Fehler- und Logging-Verhalten
...
| `message(WARNING ...)` | Verdächtige Konfiguration |
| `message(STATUS ...)` | Informativ |

Empfohlen: Projekt-Wrapper für konsistente Fehlercodes:
