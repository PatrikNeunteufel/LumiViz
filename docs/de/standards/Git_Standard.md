...
> **Sprache:** Deutsch  
> **English:** [Git_Standard.md](../../en/standards/Git_Standard.md)
...
8. [Git-Konfiguration](#8-git-konfiguration)
...
| `ci` | CI/CD-Konfiguration | `ci(github): add clang-tidy workflow` |
...
| Branch | Pattern | Langlebig | Beschreibung |
|--------|---------|-----------|--------------|
| `main` | `main` | ✅ | Stabiler Release-Stand |
...
| Issue-Referenz optional | `feature/123-audio-player` oder `feature/audio-player` |
...
|-----------|----------------|
| Öffentliches Release | ✅ Ja |
| Interner Meilenstein | ✅ Optional (z.B. `v0.5.0-internal`) |
| Jeder Merge zu main | ❌ Nein |
| CI/CD Deploy | ❌ Nein (automatische Build-Nummern nutzen) |
