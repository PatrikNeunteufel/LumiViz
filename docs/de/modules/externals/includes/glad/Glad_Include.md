...
6. [Include.cmake Implementierung](#6-includecmake-implementierung)
7. [Erweiterte Konfigurationen](#7-erweiterte-konfigurationen)
...
GLAD ist ein **OpenGL Loading Library Generator**. OpenGL-Funktionen sind nicht direkt verfügbar — sie müssen zur Laufzeit geladen werden. GLAD generiert den Code dafür.
...
| Versionsspezifisch | Nur benötigte Funktionen für gewählte Version |
...
### 2.1 Standard-Konfiguration (OpenGL 3.3 Core)
...
| **Generate a loader** | ✅ (aktiviert) | Lädt Funktionen automatisch |
...
| Extension | Beschreibung | Anwendungsfall |
|-----------|--------------|----------------|
...
└── src/
    └── glad.c              ← Loader-Implementierung
```

> **Hinweis:** Die Include.cmake liegt im Convention-Pfad `cmake/externals/includes/glad/Include.cmake`, nicht im External-Ordner selbst.

---

## 6. Include.cmake Implementierung

### 6.1 Standard-Implementierung
...
# Warnungen für externen Code unterdrücken
if(MSVC)
...
### 10.2 Laufzeit-Fehler

**"gladLoadGLLoader failed":**

```cpp
// Häufigster Fehler: Kein aktiver OpenGL-Context
...
- [glfw_PreFetch.md](../hooks/prefetch/glfw_PreFetch.md) — GLFW-Konfiguration
