...
3. [hooks/postfetch/Imgui.md](hooks/postfetch/Imgui.md) — Beispiel: Post-Fetch Hook
...
|--------|---------|--------------|
| [core/](core/README.md) | 1 | Kern-Funktionen |
...
- [../../references/Externals.md](../../references/Externals.md) — Externals-Referenz
