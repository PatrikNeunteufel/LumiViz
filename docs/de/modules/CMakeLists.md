...
> **Hinweis:** Die Phasen-Nummern entsprechen der **Entwicklungsreihenfolge**, nicht der Ausführungsreihenfolge. Phase 4 (Libraries) muss vor Phase 3 (Executables) ausgeführt werden!
...
```cmake
# 1. Fehlerbehandlung (keine Abhängigkeiten)
include(cmake/core/Errors.cmake)
...
# 8. Compiler-Warnungen (nutzt Context)
include(cmake/core/Warnings.cmake)
...
> Keine direkten `message()`-Aufrufe außer für Fehler via `cmake_fatal()`.
...
- [CMakePresets.md](CMakePresets.md) — Preset-Konfiguration
