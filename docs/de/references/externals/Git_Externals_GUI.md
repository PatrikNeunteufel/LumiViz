# Git Externals: GUI & Graphics — Referenz
...
Dieses Dokument beschreibt Bibliotheken für grafische Benutzeroberflächen, Fenster-Management und Rendering.
...
**Wichtig - Reihenfolge in Solution.json:**
```json
"externals": {
    "glad": { ... },   // 1. zuerst
    "glfw": { ... },   // 2. dann
