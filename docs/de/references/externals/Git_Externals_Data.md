# Git Externals: Data & Serialization — Referenz
...
Dieses Dokument beschreibt Bibliotheken für Daten-Serialisierung, Datenbanken und Kompression.
...
| **Hook** | PreFetch empfohlen |
| **Hinweis** | SOURCE_SUBDIR: `build/cmake` |
...
**Hinweis:** CMakeLists.txt ist in `build/cmake/`. Bei FetchContent:
```cmake
