...
Dieses Dokument beschreibt grundlegende Bibliotheken für Logging und allgemeine Entwicklungsaufgaben.

> **Hinweis:** Testing und Scripting sind in separate Kategorien ausgelagert:
