# Git Externals: Media & Math — Referenz
...
Dieses Dokument beschreibt Bibliotheken für Audio, Bild-Verarbeitung und Mathematik.
...
> **Zweck:** Software-Implementierung der OpenAL 3D Audio API.
