...
Dieses Dokument beschreibt Git Scripting-Externals für das CMake Architecture Build-System.

| Library | Beschreibung | CMake | Hook |
|---------|--------------|-------|------|
| **sol2** | C++ Lua Bindings | ✅ | — |
...
> **Wichtig:** sol2 benötigt eine Lua-Implementation (lua54 als Local External empfohlen)
...
> **Wichtig:** Python Development Headers müssen installiert sein

### Verwendungsbeispiel (Python Module erstellen)
