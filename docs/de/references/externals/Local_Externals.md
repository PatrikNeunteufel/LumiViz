...
Diese Referenz listet **lokale External Libraries**, die im `externals/` Ordner bereitgestellt werden. Im Gegensatz zu Git-Externals werden diese nicht gefetcht, sondern sind vorkompiliert, generiert oder als Quellen vorhanden.
...
| Bibliothek | Typ | Beschreibung | Plattformen |
|------------|-----|--------------|-------------|
...
| 0.5.0 | 2025-12-15 | Initial: Übersicht für Local Externals |
