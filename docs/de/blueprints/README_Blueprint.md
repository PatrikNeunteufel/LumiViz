...
**[Zielgruppe 1]?**
1. [Dokument1.md](Dokument1.md) — Beschreibung
2. [Dokument2.md](Dokument2.md) — Beschreibung

**[Zielgruppe 2]?**
1. [Dokument3.md](Dokument3.md) — Beschreibung
...
1. [Master_Concept.md](concepts/Master_Concept.md) — Architektur verstehen
2. [Errors.md](../modules/core/Errors.md) — Fehlerbehandlung

**Externe Library einbinden?**
1. [Externals.md](Externals.md) — Übersicht
...
| **Priorisiert** | Wichtigstes zuerst pro Pfad |
| **Verlinkt** | Direkte Links zu Dokumenten |
| **Kurze Beschreibung** | Was lernt man dort? |
...
### 8.1 Vollständiges Beispiel: modules/externals/README.md
...
- [ ] Jede Datei hat eine aussagekräftige Beschreibung
- [ ] Links funktionieren
