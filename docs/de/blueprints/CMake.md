...
> **Geltungsbereich:** Alle .cmake Dateien  
> **Sprache:** Deutsch  
> **English:** [CMake.md](../../en/blueprints/CMake.md)
...
10. [Review-Checkliste](#10-review-checkliste)
...
#[[
    ...
    Ausführliche Beschreibung, was die Funktion macht.
    
    Parameters:
        PARAM1   - Mandatory: Beschreibung
        PARAM2   - Mandatory: Beschreibung
        OPTIONAL - Optional: Beschreibung (Default: wert)
...
Zwischen Funktionen immer eine visuelle Trennung:

```cmake
# ============================================================================
# function_one - Beschreibung
# ============================================================================
function(function_one)
endfunction()

# ============================================================================
# function_two - Beschreibung
# ============================================================================
...
### 7.1 Fehler-Funktionen verwenden
...
|------|-----------|---------------|
| MAJOR | Breaking Changes | API-Änderung, Parameter-Änderung |
| MINOR | Neue Features | Neue Funktion, neuer Parameter |
| PATCH | Bugfixes | Fehlerkorrektur, Optimierung |
...
| Fehlerbehandlung mit Errors.cmake | `cmake_fatal(E0501 "...")` |
| Dokumentation für jede public Funktion | Siehe Abschnitt 5 |
| Früh validieren | Pflicht-Parameter am Anfang prüfen |
...
| Undokumentierte Funktionen | Unwartbar | Dokumentationsblock |
...
- [ ] Alle public Funktionen dokumentiert
...
|---------|-------|------------|
| **0.5.0** | **2025-12-13** | **Neu: Inhaltsverzeichnis mit Ankern, Error-Handling-Kategorien, Best Practices erweitert** |
