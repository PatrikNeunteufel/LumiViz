...
> **Geltungsbereich:** Alle `.clang-format`-Konfigurationen  
...
Dieses Blueprint definiert **Struktur und Wartung** der `.clang-format`-Konfiguration.

**Was dieses Dokument ist:**
- Konzeptuelle Grundlage für Formatierungsregeln
- Definition von Verantwortlichkeiten und Änderungsprozessen
- Erklärung der Intentionen hinter den Regeln

**Was dieses Dokument nicht ist:**
- Die technische Konfiguration selbst (→ `.clang-format`-Datei)
...
- Änderungen folgen dem Prozess in Abschnitt 7

---

## 4. Formatierungsrichtlinien (Konzept)
...
2. **Review:** Architektur-/Tooling-Team
3. **Umsetzung:**
...
| Änderung | Aktion |
|----------|--------|
| Konzeptuell (Klammer-Stil, Einrückung) | Version erhöhen, Blueprint aktualisieren |
