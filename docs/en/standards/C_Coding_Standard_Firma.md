...
> **Scope:** Alle C-Projekte (Embedded, Firmware, TMS320, dsPIC)  
> **Language:** English
...
15. [Errorbehandlung](#15-fehlerbehandlung)
...
Bei Functions, switch-cases, if-else, while und for: Kommentar was beendet wird.
...
| **Functions** | UPPER_CASE | `INITIALIZE_HARDWARE()` |
...
> **Note:** Namen mit doppeltem Unterstrich (`__`) sind gemäss C-Standard reserviert für Compiler/Implementation. Diese Konvention wird aus historischen Gründen beibehalten — bei neuen Projekten kann alternativ `_MODULE_NAME_H_` verwendet werden.
...
Vor jeder Funktion eine Asterisk-Linie, dann Titel mit Unterstreichung (=), dann Description.
...
| `_Documentation/Platforms/<Name>` | Allgemeine Description einer Plattform |
| `_Documentation/Platforms/<Name>/Variants` | Overview für Varianten-spezifische Teile |
| `_Documentation/Platforms/<Name>/Functions` | Description jeder Funktion oder jedes Moduls |
...
| Version | Datum | Changes |
|---------|-------|------------|
| **1.1.0** | **2025-12-19** | **Neu: Union-Grundlagen (11.4) mit Best Practices und Examplesn** |
