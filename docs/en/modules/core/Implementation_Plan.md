...
> **Based on:** master_concept v0.5, Solution_Schema v0.1, ErrorCodes v0.1  
...
**Ziel:** Testbare App-Architecture mit Core/Runner-Trennung.
...
|---------|-------|-----------|
| E4xx | E401-E407 | AppContainer-Error |
| W4xx | W401-W403 | AppContainer-Warningen |
