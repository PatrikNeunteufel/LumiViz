...
| Modul | Description | Dokumentation |
|-------|--------------|---------------|
...
| **packages/Qt6.cmake** | Qt6-spezifische Configuration | [packages/Qt6_cmake.md](packages/Qt6_cmake.md) |
| **packages/Boost.cmake** | Boost-spezifische Configuration | [packages/Boost_cmake.md](packages/Boost_cmake.md) |
...
- [System_Externals_Concept.md](../../projects/buildsystem/concepts/System_Externals_Concept.md) — Concept-Dokument
