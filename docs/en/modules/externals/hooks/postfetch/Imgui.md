...
> **Language:** English  
> **German:** [imgui_PostFetch.md](../../en/modules/externals/imgui_PostFetch.md)  
...
**Important:** Der Hook verwendet `${HOOK_EXTERNAL_NAME}` für Target-Namen.
