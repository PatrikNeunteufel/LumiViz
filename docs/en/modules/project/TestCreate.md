...
> **Language:** English  
> **German:** [TestCreate.md](../../en/modules/project/TestCreate.md)  
> **Module:** [`cmake/project/TestCreate.cmake`](../../../../cmake/project/TestCreate.cmake)  
...
ctest --output-on-failure           # Output bei Errorn
```
