...
> **Language:** English  
> **German:** [Testing_UserGuide.md](../../en/userguides/Testing.md)
...
7. [Solution.json Configuration](#7-solutionjson-konfiguration)
...
Dieses Guide behandelt **Projekt-Tests**.

### Features

- Deklarative Configuration via Solution.json
...
| Typ | Description | Scope | Dauer |
|-----|--------------|-------|-------|
| `unit` | Einzelne Functions/Klassen | Isoliert | Schnell |
...
└─ No
    ...
    │       │   ├─ Yes → doctest
    │       │   └─ No → Catch2 oder doctest
    │       └─ Benchmarks integriert?
    │           ├─ Yes → Catch2
    │           └─ No → doctest
    └─ Parametrisierte Tests?
        ├─ Yes → GoogleTest
        └─ No → doctest oder Catch2
```
...
### 7.2 Vollständige Configuration
...
|------|-----|---------|--------------|
| `name` | string | **Required** | Test-Target-Name |
...
```bash
# Unit Tests, parallel, verbose bei Error
...
### 11.5 Linker-Error bei getesteter Library
...
- [ErrorCodes.md](../references/ErrorCodes.md) – Test-bezogene Errorcodes
...
| 0.1.0 | 2025-12-11 | Initial: Framework-Vergleich, Configuration, Examples |
