...
> **Target Audience:** C++ Developers, Build System Developers  
> **Scope:** Alle .cpp, .hpp, .tpp, .h, .c Dateien  
> **Language:** English  
> **German:** [Cpp.md](../../en/blueprints/Cpp.md)
...
This blueprint defines die **formale Struktur** für C++/C Code-Dateien. Er legt fest, wie Dateien aufgebaut sein müssen — unabhängig vom Coding-Stil.
...
| Bereich | Inhalt |
|---------|--------|
| Datei-Header | Copyright, Version, Description |
...
| **ClangTidy_Blueprint** | Statische Analyse, Warningen |
...
| Extension | Typ | Description |
|-----------|-----|--------------|
| `.hpp` | C++ Header | Deklarationen, Inline-Code |
| `.cpp` | C++ Source | Implementationen |
| `.tpp` | C++ Template | Template-Implementationen |
| `.h` | C Header | Reine C-Deklarationen |
| `.c` | C Source | Reine C-Implementationen |
...
| Template-Implementation (separiert) | `.tpp` |
 ...
 * 
 * @details [Optionale ausführlichere Description]
 * 
 * @version X.Y.Z
 * @date    YYYY-MM-DD
...
| `@details` | — | Ausführlichere Description |
...
### 4.4 Example: Vollständiger Header
...
// ============================================================
// 8. Inline / Template Implementationen (kurz)
// ============================================================
...
// ============================================================
// 10. Include für Template-Implementation (optional)
// ============================================================
#include "Example.tpp"
...
### 6.2 Importante Regel: Eigener Header zuerst
...
- Template-Implementationen, die zu lang für den Header sind
- Trennung von Deklaration und Implementation bei Templates
...
// Template-Implementation einbinden
...
1. `public:` — Öffentliche Interface zuerst
2. `protected:` — Für Ableitungen
3. `private:` — Implementationsdetails
...
```cpp
/**
 * @brief   Kurze Description der Funktion
 * 
 * @details Ausführlichere Description, wenn nötig.
 *          Kann mehrere Zeilen umfassen.
 * 
 * @param   name        Description des Parameterss
 * @param   value       Noch ein Parameters
 * 
 * @return  Was zurückgegeben wird
 * 
 * @throws  std::invalid_argument  Wenn name leer ist
 * @throws  std::runtime_error     Bei internem Error
 * 
 * @note    Importanter Note
 * @warning Warning vor Fallstricken
 * 
...
|---------|---------------|
| Öffentliche API | Required — vollständig |
